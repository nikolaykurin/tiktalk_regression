...
use Progforce\User\Models\UserGroup as UserGroupModel;
...
class AuthManager extends RainAuthManager
{
    ...
    protected $userModel = 'Progforce\User\Models\User';

    protected $groupModel = 'Progforce\User\Models\UserGroup';

    protected $throttleModel = 'Progforce\User\Models\Throttle';
