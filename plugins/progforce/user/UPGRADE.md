...
Country and State models have been removed and can be replaced by installing the plugin **Progforce.Location**. The remaining profiles fields can be replaced by installing the plugin **Progforce.UserPlus**.
...
The Notifications tab in User settings has been removed. This feature has been replaced by the [Notify plugin](https://octobercms.com/plugin/progforce-notify). How to replace this feature:

1. Install the `Progforce.Notify` plugin
