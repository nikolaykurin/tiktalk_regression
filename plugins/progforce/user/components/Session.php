...
class Session extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'progforce.user::lang.session.session',
            'description' => 'progforce.user::lang.session.session_desc'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'security' => [
                'title'       => 'progforce.user::lang.session.security_title',
                'description' => 'progforce.user::lang.session.security_desc',
                'type'        => 'dropdown',
                'default'     => 'all',
                'options'     => [
                    'all'   => 'progforce.user::lang.session.all',
                    'user'  => 'progforce.user::lang.session.users',
                    'guest' => 'progforce.user::lang.session.guests'
                ]
            ],
            'allowedUserGroups' => [
                'title'       => 'progforce.user::lang.session.allowed_groups_title',
                'description' => 'progforce.user::lang.session.allowed_groups_description',
                'placeholder' => '*',
                'type'        => 'set',
                'default'     => []
            ],
     ...
     * @return Progforce\User\Models\User
     */
    ...
    public function onLogout()
    {
        ...
        if ($user) {
            Event::fire('progforce.user.logout', [$user]);
        }
    ...
    public function onStopImpersonating()
    {
        ...
        Flash::success(Lang::get('progforce.user::lang.session.stop_impersonate_success'));
