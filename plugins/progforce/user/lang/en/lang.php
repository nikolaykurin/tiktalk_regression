...
return [
    ...
    'user' => [
        ...
        'am_actions' => 'Acoustic Model Actions',
        'delete_am_btn' => 'Delete',
        'no_model'  => 'No Acoustic Model',
        'am_recordings_actions' => 'AM Recordings Actions',
        'training_recordings_actions' => 'Training Recordings Actions',
        'no_recordings'  => 'No Recordings',
        'download_am_btn' => 'Download',
        'download_am_recordings_btn' => 'Download',
        'download_trainings_recordings_btn' => 'Download',
        'comment_developer_mode' => 'If developer mode activated, we take only half of words for AM acquisition and show log in the Game',
        // common
