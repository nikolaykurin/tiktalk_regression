<?php namespace Progforce\User\NotifyRules;

use Progforce\Notify\Classes\ModelAttributesConditionBase;
use ApplicationException;

class UserAttributeCondition extends ModelAttributesConditionBase
{
    protected $modelClass = \Progforce\User\Models\User::class;
